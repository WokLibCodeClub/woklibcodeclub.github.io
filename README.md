# Wokingham Library Code Club - github pages

This github has been created for the Wokingham Library Code Club, which takes place in Wokingham Library, Wokingham, UK

The front page - [https://github.com/WokLibCodeClub](https://github.com/WokLibCodeClub) - contains information related to the club's set up and details of the forthcoming sessions, including useful links for the students.

Coding is carried out in [Scratch](https://scratch.mit.edu/) or Python, and Python code is created with the online editor [trinket](https://trinket.strivemath.org/).
